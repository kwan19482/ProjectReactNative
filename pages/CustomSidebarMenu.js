import { StyleSheet, Text, View,SafeAreaView,Image,Linking } from 'react-native'; //linking is component for link to web like a webview
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            <View style={styles.customItem}>
                <Text onPress={()=>Linking.openURL('https://tni.ac.th')}> Rate Us</Text>
